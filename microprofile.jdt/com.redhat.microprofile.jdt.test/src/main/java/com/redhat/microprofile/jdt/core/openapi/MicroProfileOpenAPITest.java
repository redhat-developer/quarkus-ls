...
public class MicroProfileOpenAPITest extends BasePropertiesManagerTest {
	...
	public void microprofileOpenAPI() throws Exception {
		...
		assertProperties(infoFromClasspath,
				...
				p("microprofile-openapi", "mp.openapi.model.reader", "java.lang.String", 
				...
				p("microprofile-openapi", "mp.openapi.scan.classes", "java.lang.String",
				...
				p("microprofile-openapi", "mp.openapi.scan.exclude.packages", "java.lang.String",
				...
				p("microprofile-openapi", "mp.openapi.scan.exclude.classes", "java.lang.String",
				...
				p("microprofile-openapi", "mp.openapi.servers", "java.lang.String",
				...
				p("microprofile-openapi", "mp.openapi.servers.path.{*}", "java.lang.String",
				...
				p("microprofile-openapi", "mp.openapi.servers.operation.{*}", "java.lang.String",
				...
				p("microprofile-openapi", "mp.openapi.schema.{*}", "java.lang.String",
