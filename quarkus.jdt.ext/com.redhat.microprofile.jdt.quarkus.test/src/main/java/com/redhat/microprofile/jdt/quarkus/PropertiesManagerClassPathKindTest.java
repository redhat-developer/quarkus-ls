...
public class PropertiesManagerClassPathKindTest extends BasePropertiesManagerTest {
  ...
  public void configQuickstartTest() throws Exception {
    ...
    MicroProfileProjectInfo infoFromNone = PropertiesManager.getInstance().getMicroProfileProjectInfo(fileFromNone,
        MicroProfilePropertiesScope.SOURCES_AND_DEPENDENCIES, JDT_UTILS, DocumentFormat.Markdown,
    ...
    File resteasyJARFile = DependencyUtil.getArtifact("io.quarkus", "quarkus-resteasy-common-deployment", "1.0.0.CR1",
    ...
    assertProperties(infoFromSrc, 181 /* properties from JAR */ + //
        ...
        p("quarkus-resteasy-common", "quarkus.resteasy.gzip.enabled", "boolean", "If gzip is enabled", true,
            "io.quarkus.resteasy.common.deployment.ResteasyCommonProcessor.ResteasyCommonConfigGzip", "enabled", null,
            1, "false"),

        // GreetingResource
        // @ConfigProperty(name = "greeting.message")
        // String message;
        p(null, "greeting.message", "java.lang.String", null, false, "org.acme.config.GreetingResource", "message",
            null, 0, null),

        // @ConfigProperty(name = "greeting.suffix" , defaultValue="!")
        // String suffix;
        p(null, "greeting.suffix", "java.lang.String", null, false, "org.acme.config.GreetingResource", "suffix", null,
            0, "!"),

        // @ConfigProperty(name = "greeting.name")
        // Optional<String> name;
        p(null, "greeting.name", "java.util.Optional", null, false, "org.acme.config.GreetingResource", "name", null, 0,
            null));

    assertPropertiesDuplicate(infoFromSrc);

    // in /java/main/test classpath-> N + M quarkus properties
    File undertowJARFile = DependencyUtil.getArtifact("io.quarkus", "quarkus-undertow-deployment", "1.0.0.CR1", null,
        new NullProgressMonitor());
    ...
    assertProperties(infoFromTest, 181 /* properties from JAR */ + //
        ...
        // String message;
        p(null, "greeting.message.test", "java.lang.String", null, false, "org.acme.config.TestResource", "message",
            null, 0, null),

        // @ConfigProperty(name = "greeting.suffix.test" , defaultValue="!")
        // String suffix;
        p(null, "greeting.suffix.test", "java.lang.String", null, false, "org.acme.config.TestResource", "suffix", null,
            0, "!"),

        // @ConfigProperty(name = "greeting.name.test")
        // Optional<String> name;
        p(null, "greeting.name.test", "java.util.Optional", null, false, "org.acme.config.TestResource", "name", null,
            0, null)
