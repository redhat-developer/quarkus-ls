 ...
 * 
 * <ul>
 * <li>delegates language-specific scanning to subclasses</li>
 * <li>manages the lifecycle of an injection: START → CONTENT → END</li>
 * </ul>
 */
public abstract class AbstractScannerWithInjection<T, S> extends AbstractScanner<T, S>
	...
	protected AbstractScannerWithInjection(String input, //
			int initialOffset, //
			S initialState, //
			T unknownTokenType, //
			T eosTokenType, //
	 ...
	 *
	 * The order of responsibility is important: 1. EOF 2. Injection handling 3.
	 * Normal language scanning
	 */
	@Override
	 ...
	 * <ul>
	 * <li>Detection MUST NOT consume the stream.</li>
	 * <li>If an injection is detected, we return both:
	 * <ul>
	 * <li>the detector</li>
	 * <li>the metadata</li>
	 * </ul>
	 ...
	 * This method:
	 * <ul>
	 * <li>fixes the detector for the whole injection lifecycle</li>
	 * <li>computes the injection content boundaries ONCE</li>
	 * </ul>
	 */
	 ...
	 * Handles either:
	 * <ul>
	 * <li>the injected content</li>
	 * <li>or the injection end delimiter</li>
	 * </ul>
	 */
	...
	/**
	 * Exposes metadata of the current injection (if any). Used by parsers / IDE
	 * features.
	 */
	@Override
	...
	/**
	 * Allows subclasses to enable or disable injection support depending on their
	 * current state.
	 */
