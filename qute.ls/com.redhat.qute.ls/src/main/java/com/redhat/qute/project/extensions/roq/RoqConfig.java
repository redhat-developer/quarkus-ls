...
public class RoqConfig {
	...
	// See
	// https://docs.quarkiverse.io/quarkus-roq/dev/index.html#quarkus-roq-frontmatter_site-content-dir
	public static final PropertyConfig ROQ_CONTENT_DIR = new PropertyConfig("site.content.dir", "content");

	// See
	// https://docs.quarkiverse.io/quarkus-roq/dev/index.html#quarkus-roq-frontmatter_site-theme
	public static final PropertyConfig ROQ_THEME = new PropertyConfig("site.theme", null);
