...
public abstract class MockQuteProject extends QuteProject {
	...
	public MockQuteProject(ProjectInfo projectInfo, QuteProjectRegistry projectRegistry) {
		this(projectInfo, projectRegistry, null);
	}

	public MockQuteProject(ProjectInfo projectInfo, QuteProjectRegistry projectRegistry, TemplateValidator validator) {
		super(projectInfo, projectRegistry, validator);
