...
*******************************************************************************/
package com.redhat.qute.project.flags;
 ...
 * Flags project.
 */
public class FlagsProject extends BaseQuteProject {

	public static final String PROJECT_URI = "flags";

	public FlagsProject(QuteProjectRegistry projectRegistry) {
		super(new ProjectInfo(PROJECT_URI, //
				...
				Set.of(FlagsConfig.PROJECT_FEATURE)), projectRegistry);
	}
